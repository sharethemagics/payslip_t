...
public class controller {
    ...
    public String greeting(@RequestParam(value = "name", defaultValue = "World") String name) {
        ...
        try {
            ...
            cell.setBackgroundColor(lightGray);
            table.addCell(cell);
            cell = new PdfPCell(new Phrase(" 01-Jan-1990", fontContent));
            cell.setVerticalAlignment(Element.ALIGN_CENTER);
            cell.setBackgroundColor(lightGray);
            table.addCell(cell);
            ...
            cell.setBackgroundColor(lightGray);
            table.addCell(cell);
            cell = new PdfPCell(new Phrase(" 123456789", fontContent));
            cell.setVerticalAlignment(Element.ALIGN_CENTER);
            cell.setBackgroundColor(lightGray);
            table.addCell(cell);
            ...
            cell.setBackgroundColor(lightGray);
            table.addCell(cell);
            cell = new PdfPCell(new Phrase(" Bharath", fontContent));
            cell.setVerticalAlignment(Element.ALIGN_CENTER);
            cell.setBackgroundColor(lightGray);
            table.addCell(cell);
            ...
            cell.setBackgroundColor(lightGray);
            table.addCell(cell);
            cell = new PdfPCell(new Phrase(" 30-July-2018", fontContent));
            cell.setVerticalAlignment(Element.ALIGN_CENTER);
            cell.setBackgroundColor(lightGray);
            table.addCell(cell);
            ...
            cell.setBackgroundColor(lightGray);
            table.addCell(cell);
            cell = new PdfPCell(new Phrase(" Bank Transfer", fontContent));
            cell.setVerticalAlignment(Element.ALIGN_CENTER);
            cell.setBackgroundColor(lightGray);
            table.addCell(cell);
            cell = new PdfPCell(new Phrase(" ", fontTableSideHdr));
            ...
            cell.setBorderColorBottom(BaseColor.LIGHT_GRAY);
            table2.addCell(cell);
            cell = new PdfPCell(new Phrase("835.00 ", fontContent));
            cell.setPaddingRight(3);
            cell.setUseVariableBorders(true);
            cell.setBorderWidthTop(0);
            cell.setBorderWidthRight(0);
            ...
            cell.setBorderColorBottom(BaseColor.LIGHT_GRAY);
            table2.addCell(cell);
            cell = new PdfPCell(new Phrase("283.00 ", fontContent));
            cell.setPaddingRight(3);
            cell.setUseVariableBorders(true);
            cell.setBorderWidthTop(0);
            //cell.setBorderWidthLeft(0);
